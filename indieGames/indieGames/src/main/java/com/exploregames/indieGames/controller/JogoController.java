...
public class JogoController {
	...
	@GetMapping
	public ResponseEntity<List<Jogo>> findAllJogo(){
	...
	public ResponseEntity<List<Jogo>> findAllByNome(@PathVariable String nome){
	...
	@PutMapping
	public ResponseEntity<Jogo> putJogo(@RequestBody Jogo jogo){
